...
const Home = ({ categories }) => {
  ...
  const loadPopular = async () => {
    const response = await callPopular();
          ...
          <div>
            <div className="row">
              ...
              <div className="col-md-8">
                <h3 className={`categoryName${i}`}>{c.name}</h3>
              </div>
            </div>
          </div>
        </a>
  ...
  return (
    <Layout>
      <div className="row">
        <div className="col-md-12">
          <h1 className="x font-weight-bold">Browse Tutorials/Courses</h1>
          <br />
        </div>
      </div>
