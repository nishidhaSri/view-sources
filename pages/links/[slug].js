    ...
    popular.map((l, i) => (
      <div key={i} className="row alert alert-secondary p-2">
        <div className="col-md-8" onClick={() => handleClick(l._id)}>
          <a href={l.url} target="_blank" style={{ wordBreak: "break-word" }}>
            <h5 style={{ wordBreak: "break-word" }} className="pt-2">
              {l.title}
            </h5>
            <h6
              className="pt-2 text-danger text-break"
      ...
      <Layout>
        <div className="row">
          <div className="col-md-8">
            ...
            <div
              className="lead alert alert-secondary pt-4 text-break"
